...
const getStatusConfig = (status) => {
    const configs = {
        ...
        arrived: { color: 'bg-indigo-50 text-indigo-700 border-indigo-200', label: 'Arrived' },
        sample_collected: { color: 'bg-purple-50 text-purple-700 border-purple-200', label: 'Sample Collected' },
        testing: { color: 'bg-orange-50 text-orange-700 border-orange-200', label: 'Testing' },
        in_progress: { color: 'bg-indigo-50 text-indigo-700 border-indigo-200', label: 'In Progress' },
        processing: { color: 'bg-amber-50 text-amber-700 border-amber-200', label: 'Quality Control' },
        ...
        completed: { color: 'bg-emerald-50 text-emerald-700 border-emerald-200', label: 'Verified' },
